...
const withdrawMoney = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: "Ha ocurrido un error al retirar dinero" });
  }
};
...
const transferMoney = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ error: "Ha ocurrido un error al realizar la transferencia" });
  }
};
...
export { addMoney, getTransactionsByUser, transferMoney, withdrawMoney };
